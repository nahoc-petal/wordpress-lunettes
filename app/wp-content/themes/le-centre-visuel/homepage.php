...
<section class="hero is-homepage-banner has-text-right is-large">
  <div class="hero-body">
    <div class="container">
      <h1 class="lato title has-text-accent is-uppercase">
        Forfaits
      </h1>
      <h2 class="lato is-uppercase has-text-accent subtitle">
        Disponibles à partir de
      </h2>
      <h3 class="lato title has-text-accent is-uppercase">
        149 $
      </h3>
      <span class="lato has-text-accent is-uppercase">Mode&nbsp;&nbsp;&nbsp;—&nbsp;&nbsp;&nbsp;</span>
      <span class="lato has-text-accent is-uppercase">Santé&nbsp;&nbsp;&nbsp;—&nbsp;&nbsp;&nbsp;</span>
      <span class="lato has-text-accent is-uppercase">Confort</span>
    </div>
  </div>
</section>
<br />
